...
export default async channelID => {
    ...
    const rawFetch = await fetch(`https://www.googleapis.com/youtube/v3/playlistItems?part=snippet,contentDetails&maxResults=50&key=${ytKey}&playlistId=${playlistId}`)
